...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  /// have to delete old avatar mage from cloudinary
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  // pipeline to count how manu subscriber does a channel have and channel subscribed to count
  const channel = await User.aggregate([
    ...
    {
      $lookup: {
        // pipeline to count channel subscriber
        from: "subscriptions",
        localField: "_id",
    ...
    {
      $lookup: {
        // pipeline to count channel subscribed to other channels
        from: "subscriptions",
        localField: "_id",
